...
<hr />
    ...
    <div className="rows">
        ...
        <div className="rowItem"><Products title="60W Bulb " price="30" image={bulb} rating='⭐⭐'/></div>
        <div className="rowItem"><Products title="AA Battery set" price="6" image={battery} rating='⭐⭐⭐'/></div>
    </div>
    
    <div className="rows">
        <div className="rowItem"><Products title="Notebook set" price="8" image={notebook} rating='⭐⭐⭐⭐⭐'/></div>
